...
func (x *Envelope) GetMeshStreamOpen() *MeshStreamOpen {
	if x != nil {
		if x, ok := x.Payload.(*Envelope_MeshStreamOpen); ok {
...
func (x *Envelope) GetMeshStreamOpenAck() *MeshStreamOpenAck {
	if x != nil {
		if x, ok := x.Payload.(*Envelope_MeshStreamOpenAck); ok {
...
func (x *Envelope) GetMeshStreamData() *MeshStreamData {
	if x != nil {
		if x, ok := x.Payload.(*Envelope_MeshStreamData); ok {
...
func (x *Envelope) GetMeshStreamClose() *MeshStreamClose {
	if x != nil {
		if x, ok := x.Payload.(*Envelope_MeshStreamClose); ok {
...
const file_agent_proto_rawDesc = "" +
	"\n" +
	"\vagent.proto\x12\x11platypus.agent.v1\"\xe5*\n" +
	"\bEnvelope\x12\x18\n" +
	...
	"\x10mesh_stream_open\x18J \x01(\v2!.platypus.agent.v1.MeshStreamOpenH\x00R\x0emeshStreamOpen\x12W\n" +
	"\x14mesh_stream_open_ack\x18K \x01(\v2$.platypus.agent.v1.MeshStreamOpenAckH\x00R\x11meshStreamOpenAck\x12M\n" +
	"\x10mesh_stream_data\x18L \x01(\v2!.platypus.agent.v1.MeshStreamDataH\x00R\x0emeshStreamData\x12P\n" +
	"\x11mesh_stream_close\x18M \x01(\v2\".platypus.agent.v1.MeshStreamCloseH\x00R\x0fmeshStreamClose\x12M\n" +
	...
	"\x0etarget_node_id\x18\x03 \x01(\tR\ftargetNodeId\x125\n" +
	"\x04kind\x18\x04 \x01(\x0e2!.platypus.agent.v1.MeshStreamKindR\x04kind\"\x82\x01\n" +
	...
	"\aversion\x18\a \x01(\tR\aversion\"\xdf\x02\n" +
	...
	"\n" +
	"mesh_peers\x18\x06 \x03(\tR\tmeshPeers\x12&\n" +
	"\x0fmesh_project_id\x18\n" +
	" \x01(\tR\rmeshProjectId\x120\n" +
	...
	"\x10TUNNEL_MODE_PUSH\x10\x01*Y\n" +
	"\x0eMeshStreamKind\x12 \n" +
	"\x1cMESH_STREAM_KIND_UNSPECIFIED\x10\x00\x12%\n" +
	"!MESH_STREAM_KIND_BOOTSTRAP_SERVER\x10\x01B;Z9github.com/WangYihang/Platypus/pkg/proto/agent/v1;agentpbb\x06proto3"
