...
func (*MeshLSA_Link) Descriptor() ([]byte, []int) {
	return file_agent_proto_rawDescGZIP(), []int{44, 0}
}
...
const file_agent_proto_rawDesc = "" +
	"\n" +
	"\vagent.proto\x12\x11platypus.agent.v1\"\x96!\n" +
	"\bEnvelope\x12\x18\n" +
...
var file_agent_proto_goTypes = []any{
	...
	(*TunnelCreateRequest)(nil),      // 23: platypus.agent.v1.TunnelCreateRequest
	(*TunnelCreatedResponse)(nil),    // 24: platypus.agent.v1.TunnelCreatedResponse
	(*TunnelCreateFailed)(nil),       // 25: platypus.agent.v1.TunnelCreateFailed
	(*TunnelConnectRequest)(nil),     // 26: platypus.agent.v1.TunnelConnectRequest
	(*TunnelConnectedResponse)(nil),  // 27: platypus.agent.v1.TunnelConnectedResponse
	(*TunnelConnectFailed)(nil),      // 28: platypus.agent.v1.TunnelConnectFailed
	(*TunnelData)(nil),               // 29: platypus.agent.v1.TunnelData
	(*TunnelCloseRequest)(nil),       // 30: platypus.agent.v1.TunnelCloseRequest
	(*TunnelClosedNotice)(nil),       // 31: platypus.agent.v1.TunnelClosedNotice
	(*TunnelDisconnectedNotice)(nil), // 32: platypus.agent.v1.TunnelDisconnectedNotice
	(*Socks5CreateRequest)(nil),      // 33: platypus.agent.v1.Socks5CreateRequest
	(*Socks5CreatedResponse)(nil),    // 34: platypus.agent.v1.Socks5CreatedResponse
	(*Socks5CreateFailed)(nil),       // 35: platypus.agent.v1.Socks5CreateFailed
	(*Socks5DestroyRequest)(nil),     // 36: platypus.agent.v1.Socks5DestroyRequest
	(*Socks5DestroyedResponse)(nil),  // 37: platypus.agent.v1.Socks5DestroyedResponse
	(*Socks5DestroyFailed)(nil),      // 38: platypus.agent.v1.Socks5DestroyFailed
	(*NodeInfo)(nil),                 // 39: platypus.agent.v1.NodeInfo
	(*MeshHello)(nil),                // 40: platypus.agent.v1.MeshHello
	(*MeshHelloAck)(nil),             // 41: platypus.agent.v1.MeshHelloAck
	(*MeshKeepalive)(nil),            // 42: platypus.agent.v1.MeshKeepalive
	(*MeshPeerAnnounce)(nil),         // 43: platypus.agent.v1.MeshPeerAnnounce
	(*MeshPeerDelta)(nil),            // 44: platypus.agent.v1.MeshPeerDelta
	(*MeshLSA)(nil),                  // 45: platypus.agent.v1.MeshLSA
	(*MeshUnreachable)(nil),          // 46: platypus.agent.v1.MeshUnreachable
	(*AgentEnrollRequest)(nil),       // 47: platypus.agent.v1.AgentEnrollRequest
	(*AgentEnrollResponse)(nil),      // 48: platypus.agent.v1.AgentEnrollResponse
	(*SessionRenewRequest)(nil),      // 49: platypus.agent.v1.SessionRenewRequest
	(*SessionRenewResponse)(nil),     // 50: platypus.agent.v1.SessionRenewResponse
	nil,                              // 51: platypus.agent.v1.ClientInfoResponse.NetworkInterfacesEntry
	(*MeshLSA_Link)(nil),             // 52: platypus.agent.v1.MeshLSA.Link
}
var file_agent_proto_depIdxs = []int32{
	...
	23, // 20: platypus.agent.v1.Envelope.tunnel_create_request:type_name -> platypus.agent.v1.TunnelCreateRequest
	24, // 21: platypus.agent.v1.Envelope.tunnel_created_response:type_name -> platypus.agent.v1.TunnelCreatedResponse
	25, // 22: platypus.agent.v1.Envelope.tunnel_create_failed:type_name -> platypus.agent.v1.TunnelCreateFailed
	29, // 23: platypus.agent.v1.Envelope.tunnel_data:type_name -> platypus.agent.v1.TunnelData
	30, // 24: platypus.agent.v1.Envelope.tunnel_close_request:type_name -> platypus.agent.v1.TunnelCloseRequest
	31, // 25: platypus.agent.v1.Envelope.tunnel_closed:type_name -> platypus.agent.v1.TunnelClosedNotice
	26, // 26: platypus.agent.v1.Envelope.tunnel_connect_request:type_name -> platypus.agent.v1.TunnelConnectRequest
	27, // 27: platypus.agent.v1.Envelope.tunnel_connected_response:type_name -> platypus.agent.v1.TunnelConnectedResponse
	28, // 28: platypus.agent.v1.Envelope.tunnel_connect_failed:type_name -> platypus.agent.v1.TunnelConnectFailed
	32, // 29: platypus.agent.v1.Envelope.tunnel_disconnected:type_name -> platypus.agent.v1.TunnelDisconnectedNotice
	33, // 30: platypus.agent.v1.Envelope.socks5_create_request:type_name -> platypus.agent.v1.Socks5CreateRequest
	34, // 31: platypus.agent.v1.Envelope.socks5_created_response:type_name -> platypus.agent.v1.Socks5CreatedResponse
	35, // 32: platypus.agent.v1.Envelope.socks5_create_failed:type_name -> platypus.agent.v1.Socks5CreateFailed
	36, // 33: platypus.agent.v1.Envelope.socks5_destroy_request:type_name -> platypus.agent.v1.Socks5DestroyRequest
	37, // 34: platypus.agent.v1.Envelope.socks5_destroyed_response:type_name -> platypus.agent.v1.Socks5DestroyedResponse
	38, // 35: platypus.agent.v1.Envelope.socks5_destroy_failed:type_name -> platypus.agent.v1.Socks5DestroyFailed
	40, // 36: platypus.agent.v1.Envelope.mesh_hello:type_name -> platypus.agent.v1.MeshHello
	41, // 37: platypus.agent.v1.Envelope.mesh_hello_ack:type_name -> platypus.agent.v1.MeshHelloAck
	42, // 38: platypus.agent.v1.Envelope.mesh_keepalive:type_name -> platypus.agent.v1.MeshKeepalive
	43, // 39: platypus.agent.v1.Envelope.mesh_peer_announce:type_name -> platypus.agent.v1.MeshPeerAnnounce
	44, // 40: platypus.agent.v1.Envelope.mesh_peer_delta:type_name -> platypus.agent.v1.MeshPeerDelta
	45, // 41: platypus.agent.v1.Envelope.mesh_lsa:type_name -> platypus.agent.v1.MeshLSA
	46, // 42: platypus.agent.v1.Envelope.mesh_unreachable:type_name -> platypus.agent.v1.MeshUnreachable
	47, // 43: platypus.agent.v1.Envelope.agent_enroll_request:type_name -> platypus.agent.v1.AgentEnrollRequest
	48, // 44: platypus.agent.v1.Envelope.agent_enroll_response:type_name -> platypus.agent.v1.AgentEnrollResponse
	49, // 45: platypus.agent.v1.Envelope.session_renew_request:type_name -> platypus.agent.v1.SessionRenewRequest
	50, // 46: platypus.agent.v1.Envelope.session_renew_response:type_name -> platypus.agent.v1.SessionRenewResponse
	51, // 47: platypus.agent.v1.ClientInfoResponse.network_interfaces:type_name -> platypus.agent.v1.ClientInfoResponse.NetworkInterfacesEntry
	4,  // 48: platypus.agent.v1.SysInfoResponse.info:type_name -> platypus.agent.v1.SysInfo
	0,  // 49: platypus.agent.v1.TunnelCreateRequest.mode:type_name -> platypus.agent.v1.TunnelMode
	39, // 50: platypus.agent.v1.MeshPeerAnnounce.nodes:type_name -> platypus.agent.v1.NodeInfo
	39, // 51: platypus.agent.v1.MeshPeerDelta.added:type_name -> platypus.agent.v1.NodeInfo
	52, // 52: platypus.agent.v1.MeshLSA.links:type_name -> platypus.agent.v1.MeshLSA.Link
