...
type NodeInfo struct {
	...
	CertPem          []byte                 `protobuf:"bytes,7,opt,name=cert_pem,json=certPem,proto3" json:"cert_pem,omitempty"`                             // project-CA-signed leaf, used for chain verify
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type MeshPeerAnnounce struct {
	...
	Pubkey        []byte                 `protobuf:"bytes,3,opt,name=pubkey,proto3" json:"pubkey,omitempty"`                                      // must equal cert SPKI
	Sig           []byte                 `protobuf:"bytes,4,opt,name=sig,proto3" json:"sig,omitempty"`                                            // Ed25519_sign(priv, canonical(announce without sig))
	OriginCertPem []byte                 `protobuf:"bytes,5,opt,name=origin_cert_pem,json=originCertPem,proto3" json:"origin_cert_pem,omitempty"` // project-CA-signed leaf
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MeshPeerDelta struct {
	...
	OriginCertPem []byte                 `protobuf:"bytes,8,opt,name=origin_cert_pem,json=originCertPem,proto3" json:"origin_cert_pem,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_mesh_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"mesh.proto\x12\vplatypus.v2\"\xa8\x06\n" +
	...
	"\apayloadJ\x04\b\n" +
	"\x10\vJ\x04\b\v\x10\fJ\x04\b\r\x10\x0e\"\xd2\x01\n" +
	"\bNodeInfo\x12\x17\n" +
	...
	"\bcert_pem\x18\a \x01(\fR\acertPem\"\xd8\x01\n" +
...
var file_mesh_proto_goTypes = []any{
	...
	(*MeshKeepalive)(nil),     // 3: platypus.v2.MeshKeepalive
	(*MeshPeerAnnounce)(nil),  // 4: platypus.v2.MeshPeerAnnounce
	(*MeshPeerDelta)(nil),     // 5: platypus.v2.MeshPeerDelta
	(*MeshLSA)(nil),           // 6: platypus.v2.MeshLSA
	(*MeshUnreachable)(nil),   // 7: platypus.v2.MeshUnreachable
	(*MeshStreamOpen)(nil),    // 8: platypus.v2.MeshStreamOpen
	(*MeshStreamOpenAck)(nil), // 9: platypus.v2.MeshStreamOpenAck
	(*MeshStreamData)(nil),    // 10: platypus.v2.MeshStreamData
	(*MeshStreamClose)(nil),   // 11: platypus.v2.MeshStreamClose
	(*MeshLSA_Link)(nil),      // 12: platypus.v2.MeshLSA.Link
}
var file_mesh_proto_depIdxs = []int32{
	3,  // 0: platypus.v2.MeshEnvelope.keepalive:type_name -> platypus.v2.MeshKeepalive
	4,  // 1: platypus.v2.MeshEnvelope.peer_announce:type_name -> platypus.v2.MeshPeerAnnounce
	5,  // 2: platypus.v2.MeshEnvelope.peer_delta:type_name -> platypus.v2.MeshPeerDelta
	6,  // 3: platypus.v2.MeshEnvelope.lsa:type_name -> platypus.v2.MeshLSA
	7,  // 4: platypus.v2.MeshEnvelope.unreachable:type_name -> platypus.v2.MeshUnreachable
	8,  // 5: platypus.v2.MeshEnvelope.stream_open:type_name -> platypus.v2.MeshStreamOpen
	9,  // 6: platypus.v2.MeshEnvelope.stream_open_ack:type_name -> platypus.v2.MeshStreamOpenAck
	10, // 7: platypus.v2.MeshEnvelope.stream_data:type_name -> platypus.v2.MeshStreamData
	11, // 8: platypus.v2.MeshEnvelope.stream_close:type_name -> platypus.v2.MeshStreamClose
	2,  // 9: platypus.v2.MeshPeerAnnounce.nodes:type_name -> platypus.v2.NodeInfo
	2,  // 10: platypus.v2.MeshPeerDelta.added:type_name -> platypus.v2.NodeInfo
	12, // 11: platypus.v2.MeshLSA.links:type_name -> platypus.v2.MeshLSA.Link
	0,  // 12: platypus.v2.MeshStreamOpen.kind:type_name -> platypus.v2.MeshStreamKind
