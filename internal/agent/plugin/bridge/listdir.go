...
// listDirPluginID is the system plugin id that owns this handler.
// Bumping the version is OK; bumping the id requires updating every
// agent build that depends on it (the bundle moves with the code).
const listDirPluginID = "com.platypus.sys-listdir"
