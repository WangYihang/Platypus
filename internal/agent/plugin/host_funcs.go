...
func (pctx *pluginCtx) buildHostFunctions() []extism.HostFunction {
	return []extism.HostFunction{
		...
		newHostFunc("host_collect_sysinfo", []api.ValueType{},
			[]api.ValueType{api.ValueTypeI64}, pctx.hostCollectSysInfo),
		newHostFunc("host_security_scan", []api.ValueType{api.ValueTypeI64},
			[]api.ValueType{api.ValueTypeI64}, pctx.hostSecurityScan),
		newHostFunc("host_list_security_checks", []api.ValueType{},
			[]api.ValueType{api.ValueTypeI64}, pctx.hostListSecurityChecks),
		newHostFunc("host_config_audit", []api.ValueType{api.ValueTypeI64},
			[]api.ValueType{api.ValueTypeI64}, pctx.hostConfigAudit),
		newHostFunc("host_list_config_auditors", []api.ValueType{},
			[]api.ValueType{api.ValueTypeI64}, pctx.hostListConfigAuditors),
