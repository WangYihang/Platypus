...
// local/remote health without fanning out to /listeners and /sessions.
...
// @Description Returns the server's build version/commit/date, process start time, and current listener and session counts. Intended for lightweight dashboard/status-bar polling.
// @Tags        info
// @Produce     json
// @Security    BearerAuth
