-- 000016_drop_aat.up.sql — retire the AAT (AI Agent Token) surface.
--
-- AAT was an admin-only experimental feature; the new user-self PAT
-- (introduced in migration 17) covers the same use case in a more
...
-- migration 17 rebuilds the table — SQLite cannot ALTER a CHECK in
