...
func TestTopologyFromLSDBOnly(t *testing.T) {
	...
	if _, err := n.lsdb.Ingest(buildSignedLSA(t, a, 1, b.NodeID)); err != nil {
		t.Fatalf("ingest A: %v", err)
	}
	if _, err := n.lsdb.Ingest(buildSignedLSA(t, b, 1, a.NodeID)); err != nil {
...
func TestTopologyEdgeDedup(t *testing.T) {
	...
	if _, err := n.lsdb.Ingest(buildSignedLSA(t, peer, 1, self.NodeID)); err != nil {
