...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/internal_api.tokenError"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.dispatchRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api.dispatchResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/sessions/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Fields to patch (any subset)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.patchSessionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 0,
                        "description": "Number of bytes to read; 0 = whole file",
                        "name": "size",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "boolean",
                        "default": false,
                        "description": "If true, appends to the file instead of truncating",
                        "name": "append",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/sessions/{id}/tunnels": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Mode + addresses",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.createTunnelRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_api.createTunnelRequest": {
            ...
            "properties": {
                "dst_address": {
                    "description": "DstAddress is required for pull/push/internet modes. Ignored for dynamic.",
                    "type": "string"
                },
                "mode": {
                    "description": "Mode is one of \"pull\", \"push\", \"dynamic\", \"internet\".",
                    "type": "string"
                },
                "src_address": {
                    "description": "SrcAddress is required for pull/push/internet modes. Ignored for dynamic.",
                    "type": "string"
                }
            }
        },
        "internal_api.dispatchRequest": {
            "type": "object",
            "required": [
                "command"
            ],
            "properties": {
                ...
                "timeout": {
                    "description": "seconds; defaults to 3 when ≤0",
                    "type": "integer"
                }
            }
        },
        "internal_api.dispatchResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
                ...
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api.dispatchResult"
                    }
                },
                "status": {
                    "type": "boolean"
        ...
        "internal_api.tokenRequest": {
            ...
            "properties": {
                "secret": {
                    "description": "Secret is the value printed at server startup (\"API secret: …\").",
                    "type": "string"
                }
            }
        },
