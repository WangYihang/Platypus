...
// globalTeardown runs once after all specs. Kills the backend, then
// removes the temp dir. Per-spec agents clean themselves up via their
// own afterEach / fixture scopes. Frontend is managed by Playwright's
// webServer.
