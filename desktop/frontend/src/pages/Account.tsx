...
// Account is the home of user-self, server-side settings. Today that's
// just "Change password" (lifted out of the UserMenu popover Dialog so
// it sits where users go looking for it), plus a read-only identity
// card. Future home for self-PAT management, locale, theme override.
//
// Distinct from /preferences: those values live in localStorage and
// don't roundtrip to the server. The PageHeader subtitle names the
// scope ("Account · {username}") so the surface reads honestly.
